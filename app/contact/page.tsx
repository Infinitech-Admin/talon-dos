...
export default function ContactPage() {
  ...
  return (
    <PageLayout
      title="Contact Us"
      subtitle="Get in touch with Talon Dos Community"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    } focus:border-[#1e40af] focus:ring-2 focus:ring-[#1e40af]/20 transition`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-[#1e40af] focus:ring-2 focus:ring-[#1e40af]/20 transition"
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-[#1e3a8a] hover:from-blue-700 hover:to-[#16296b] text-white font-bold hover:shadow-lg transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
          ...
          >
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-[#1e40af] flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/login">
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: "0 20px 40px rgba(20, 48, 77, 0.25)",
                  }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 rounded-full bg-[#1e40af] text-white font-bold"
                >
                  Log In
                </motion.button>
              </Link>
              ...
              <Link href="/register">
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    backgroundColor: "rgba(20, 48, 77, 0.06)",
                  }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 rounded-full border-2 border-[#1e40af] text-[#1e40af] font-bold transition-colors"
                >
                  Register
                </motion.button>
              </Link>
