          ...
          >
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                By accessing and using the Talon Dos City Government System
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                ...
                materials (information or software) on Talon Dos City Government
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials on Talon Dos City Government System are provided
                on an 'as is' basis. Talon Dos City Government makes no
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                In no event shall Talon Dos City Government or its suppliers be
                ...
                Talon Dos City Government's website.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials appearing on Talon Dos City Government's website
                could include technical, typographical, or photographic errors.
                Talon Dos City Government does not warrant that any of the
