        ...
        <div className="bg-white rounded-2xl shadow-xl p-10">
          ...
          >
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4">
              <span className="text-2xl font-bold text-[#1e40af]">C</span>
            </div>
            <h1 className="text-4xl font-bold text-[#1e40af] mb-2">
              Welcome Back
            </h1>
            <p className="text-gray-600">
              Sign in to your Talon Dos City account
            </p>
          </motion.div>
          ...
          <div className="space-y-5">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${
                  errors.email
                    ...
                    : "border-blue-200 focus:border-[#1e40af] focus:ring-blue-200"
            ...
            >
              <Link
                href="#"
                className="text-sm text-[#1e40af] font-semibold hover:text-[#1e3a8a]"
              >
                Forgot password?
              </Link>
            </motion.div>
            ...
            <motion.button
              ...
              onClick={handleLogin}
              disabled={loading}
              className="w-full px-6 py-4 rounded-lg bg-gradient-to-r from-blue-600 to-[#1e3a8a] text-white font-bold hover:shadow-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
          ...
          >
            <p className="text-gray-600">
              ...
              <Link
                href="/register"
                className="text-[#1e40af] font-bold hover:text-[#1e3a8a]"
              >
                Register here
              </Link>
            </p>
