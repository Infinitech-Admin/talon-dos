      ...
      <div className="flex flex-col min-h-screen bg-slate-50">
        ...
        <header className="bg-white px-4 py-4 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-900">Startup Hub</h1>
          </div>
        </header>
          ...
          <Card className="mb-6 border-blue-200 bg-blue-50">
            <CardContent className="p-4">
              <h2 className="font-semibold text-slate-900 mb-2">
                Launch Your Startup in Talon Dos
              </h2>
              <p className="text-sm text-slate-700">
                Access resources, funding, and support to turn your business
                idea into reality.
              </p>
            </CardContent>
          </Card>
            ...
            <div key={sectionIdx} className="mb-6">
              ...
              <div className="space-y-3">
                {section.items.map((item, itemIdx) => {
                  ...
                  return (
                    <Card key={itemIdx} className="border-slate-200">
                      <CardContent className="p-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="text-blue-700 hover:text-blue-700 hover:bg-blue-50 p-0 h-auto font-medium"
                              onClick={() =>
