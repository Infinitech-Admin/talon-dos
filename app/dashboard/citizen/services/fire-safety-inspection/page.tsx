          ...
          <Card className="mb-6 border-l-4 border-l-blue-600">
            <CardHeader>
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-blue-700 mt-1" />
                <div>
                  ...
                  <CardDescription>
                    ...
                    Government of Talon Dos does not issue FSIC. Please visit
                    the BFP Talon Dos City Fire Station.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  Bureau of Fire Protection - Talon Dos City
                </h4>
                <div className="space-y-1 text-sm text-slate-700">
                  <p>
                    <strong>Office:</strong> BFP Talon Dos City Fire Station
                  </p>
                  <p>
                    <strong>Address:</strong> Talon Dos City, Oriental Mindoro
                  </p>
                  <p>
                  ...
                  <p className="text-xs text-slate-600 mt-2">
                    Note: Contact the BFP Talon Dos office for exact location
                    and to schedule your inspection
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <ol className="space-y-3">
                {[
                  ...
                  {
                    title: "Visit BFP Talon Dos",
                    desc: "Go to BFP Talon Dos Fire Station and submit application form with requirements",
                  },
                  {
                  ...
                  <li key={index} className="flex gap-3 text-sm">
                    <span className="flex-shrink-0 w-6 h-6 bg-blue-700 text-white rounded-full flex items-center justify-center text-xs font-bold">
                      {index + 1}
                    </span>
                    <div>
            ...
            <CardContent>
              ...
              <div className="bg-slate-50 p-4 rounded-lg space-y-2 text-sm">
                ...
                <p className="text-xs text-slate-600 mt-3">
                  Note: Exact fees should be confirmed with BFP Talon Dos office
                  as rates may vary
                </p>
              </div>
            </CardContent>
