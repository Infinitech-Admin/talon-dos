              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    ...
                    National Police (PNP). The City Government of Talon Dos does
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Where to Apply in Talon Dos City
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-slate-700">
                  <p>
                    <strong>Address:</strong> Talon Dos City Police Station,
                    Oriental Mindoro
                  </p>
                  <p>
              ...
              <ol className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Go to Talon Dos City Police Station or your barangay police station",
                  },
                  {
