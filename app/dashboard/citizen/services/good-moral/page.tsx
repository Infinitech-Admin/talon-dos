...
// sent to /login and back. NOTE: File objects (validId / proofOfResidency)
...
const DRAFT_KEY = "good-moral-certificate-draft";
...
export default function GoodMoralCertificatePage() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        ...
        console.error("Failed to restore good moral certificate draft:", err);
      }
  ...
  const saveDraft = () => {
    const { validId, proofOfResidency, ...textFields } = formData;
    const draft: DraftShape = {
      step: currentStep,
      hadFiles: !!(validId || proofOfResidency),
      formData: textFields,
    };
    try {
      sessionStorage.setItem(DRAFT_KEY, JSON.stringify(draft));
    } catch (err) {
      console.error("Failed to save good moral certificate draft:", err);
    }
  };
    ...
    try {
      ...
      if (formData.proofOfResidency) {
        formDataToSend.append(
          "proof_of_residency",
          formData.proofOfResidency as File,
        );
      }
      ...
      if (response.ok && data.success) {
        ...
        toast({
          title: "Success!",
          description:
            "Your good moral certificate application has been submitted.",
        });
      } else {
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Your good moral certificate application has been received
              </CardDescription>
            </CardHeader>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-slate-900 mb-2">
              Certificate of Good Moral Application
            </h1>
            <p className="text-slate-600">
              Apply for your barangay certificate of good moral character
            </p>
          </div>
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-slate-500">
                          Please specify why you need a certificate of good
                          moral character
                        </p>
                      </div>
                    </div>
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-sm text-slate-500">
                          Upload supporting documents like barangay clearance,
                          utility bills, etc. (Optional)
                        </p>
                        {formData.proofOfResidency && (
                          <div className="flex items-center gap-2 p-2 bg-blue-50 border border-blue-200 rounded">
                            <CheckCircle2 className="w-4 h-4 text-blue-600" />
                            <p className="text-sm text-blue-800">
                              File selected: {formData.proofOfResidency.name}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                        ...
                        <p className="text-xs text-amber-700">
                          A Certificate of Good Moral Character certifies that
                          you are of good standing in the community with no
                          record of misconduct. This is commonly required for
                          employment, education, and volunteer applications.
                        </p>
                      </div>
                    </div>
                  )}
