...
function ApplicationsContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-slate-50 pb-20 lg:pb-0">
      <div className="bg-white border-b shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Browse by category</p>
              </div>
            </div>
            <Button
              variant="outline"
          ...
          <div className="grid grid-cols-4 gap-2">
            <div className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-lg p-2.5 text-center shadow">
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent>
                      ...
                      <Button
                        variant="ghost"
                        className="w-full mt-4 group-hover:bg-blue-800 group-hover:text-white transition-colors"
                      >
                        View Applications
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 border-slate-200 focus:border-blue-600 focus:ring-blue-600"
                  />
                </div>
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-700 to-blue-900 flex items-center justify-center shadow-md flex-shrink-0 group-hover:scale-110 transition-transform">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-4 mb-2">
                            <div className="flex-1 min-w-0">
                              <h3 className="font-bold text-lg text-slate-900 truncate group-hover:text-blue-700 transition-colors mb-1">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="mt-3 group-hover:bg-blue-800 group-hover:text-white transition-colors"
                            onClick={(e) => {
                              e.stopPropagation();
                              setSelectedApp(app);
                            }}
      ...
      >
        <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
          <DialogHeader className="border-b pb-4">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-700 to-blue-900 flex items-center justify-center shadow-lg flex-shrink-0">
                <FileText className="h-6 w-6 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                      ...
                      {Object.entries(selectedApp).map(([key, value]) => {
                        ...
                        if (isFileArray) {
                          ...
                          return (
                            <div
                              key={key}
                              className="flex flex-col py-3 px-4 hover:bg-slate-50 transition-colors"
                            >
                              <dt className="text-sm font-semibold text-slate-700 capitalize mb-2">
                                Attachments
                              </dt>
                                ...
                                {fileList.map((file) => {
                                  ...
                                  if (isImage) {
                                    return (
                                      <div
                                        key={file.id}
                                        className="relative w-32 h-32 rounded-lg overflow-hidden border shadow-sm bg-slate-50"
                                      >
                                        <img
                                          src={fileUrl}
                                          alt={file.name}
                                ...
                                {isPdfFile ? (
                                  <div className="flex flex-col gap-2">
                                    ...
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-700 transition-colors w-fit"
                                    >
                                  ...
                                  <div className="relative w-full max-w-md h-64 rounded-lg overflow-hidden border shadow-sm bg-slate-50">
                                    <img
                        ...
                        return (
                          <div
                            key={key}
                            className="flex py-3 px-4 hover:bg-slate-50 transition-colors"
                          >
                            <dt className="text-sm font-semibold text-slate-700 capitalize w-1/3 flex-shrink-0">
                              {key.replace(/_/g, " ")}
                            </dt>
                            <dd className="text-sm text-slate-900 flex-1 break-words">
                              {(() => {
