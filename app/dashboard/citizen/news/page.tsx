...
export default function NewsPage() {
  ...
  const transformArticle = (
    ...
    const resolvedImage = article.image_url
      ? article.image_url.startsWith("http")
        ? article.image_url
        : `${apiUrl}${article.image_url}`
      : undefined;
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className="text-white/90 text-xs sm:text-sm mt-0.5">
                  Latest updates from Talon Dos City
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="px-2.5 py-1 bg-gradient-to-r from-blue-600 to-blue-800 text-white text-xs font-bold rounded-full shadow-sm">
                          {article.category}
                        </span>
                      ...
                      <h3 className="font-bold text-gray-900 mb-2 text-base sm:text-lg leading-tight group-hover:text-blue-700 transition-colors line-clamp-2">
                        {article.title}
                      </h3>
