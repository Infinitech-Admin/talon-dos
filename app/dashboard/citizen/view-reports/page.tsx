          ...
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold text-sm whitespace-nowrap transition-colors ${
                filter === tab.value ? "bg-blue-700 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
              }`}
            >
              {tab.label}
            </button>
      ...
      <main className="flex-1 px-4 py-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <Link href="/dashboard/citizen/report-issue" className="bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold">
              Submit a Report
            </Link>
          </div>
        ) : (
