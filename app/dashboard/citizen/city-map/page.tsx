...
export default function MapPage() {
  ...
  const categories = [
    { value: "all", label: "All", icon: MapPin, color: "bg-blue-700" },
    {
      value: "hospital",
      label: "Hospitals",
      icon: Hospital,
  ...
  const locations: Location[] = [
    {
      id: "1",
      name: "Talon Dos City Hospital",
      category: "hospital",
      address: "J.P. Rizal St, Talon Dos City",
      phone: "(043) 288-8888",
      lat: 13.4119,
      lng: 121.1803,
      icon: "hospital",
    ...
    {
      id: "2",
      name: "Talon Dos City Police Station",
      category: "police",
      address: "Guinobatan, Talon Dos City",
      phone: "(043) 288-6666",
      lat: 13.4125,
      lng: 121.1795,
      icon: "police",
    ...
    },
    {
      ...
      category: "school",
      address: "Camilmil, Talon Dos City",
      phone: "(043) 288-4444",
      lat: 13.41,
      lng: 121.182,
      icon: "school",
    ...
    {
      id: "6",
      name: "Talon Dos City Public Market",
      category: "landmark",
      address: "San Vicente Central, Talon Dos City",
      lat: 13.412,
      lng: 121.179,
      icon: "landmark",
    },
    ...
    <CitizenLayout requireAuth={false}>
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <header className="bg-blue-700 text-white px-4 py-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-300"
            />
          </div>
        </header>
        ...
        <div className="relative h-64 border-b border-slate-200">
          <iframe
            src="https://www.google.com/maps?q=Talon Dos+City+Hall,+Talon Dos+City,+Oriental+Mindoro&z=15&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
        ...
        <main className="flex-1 px-4 py-4 overflow-y-auto pb-20">
          <div className="flex items-center justify-between mb-4">
            ...
            {userLocation && (
              <button className="text-sm text-blue-700 font-semibold flex items-center gap-1">
            ...
            {filteredLocations.map((location) => {
              ...
              return (
                <a
                  ...
                  className="block bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow text-left"
                >
