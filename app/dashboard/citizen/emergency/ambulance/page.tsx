    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        toast({
          ...
          description:
            data.message ||
            "Failed to submit request. Please call emergency hotline.",
          variant: "destructive",
        });
      }
    } catch (error) {
  ...
  return (
    <CitizenLayout>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-8 shadow-2xl text-center max-w-sm">
            <div className="relative w-16 h-16 mx-auto mb-4">
              ...
              <Siren className="absolute inset-0 m-auto w-8 h-8 text-blue-700" />
            </div>
      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        {/* Header */}
        <header className="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 text-white px-6 py-5 shadow-lg sticky top-0 z-10">
        ...
        <main className="flex-1 p-6">
          <div className="grid lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-1 space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs opacity-90">
                      Your info is ready. Edit if needed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Warning */}
              <div className="bg-gradient-to-r from-amber-50 to-amber-100 border-2 border-amber-300 rounded-2xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-800">
                      False reports may result in penalties and delay actual
                      emergencies.
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent resize-none transition-all"
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {emergencyTypes.map((type) => (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            setFormData({ ...formData, emergency: type.value })
                          }
                          className={`p-4 rounded-xl border-2 transition-all ${
                            formData.emergency === type.value
                              ? "bg-gradient-to-br from-blue-700 to-blue-900 text-white border-transparent shadow-lg scale-105"
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-green-600 via-blue-700 to-blue-900 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:from-green-700 hover:via-blue-800 hover:to-blue-900 active:scale-98 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
