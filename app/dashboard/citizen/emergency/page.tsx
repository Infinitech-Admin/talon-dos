  ...
  return (
    <CitizenLayout requireAuth={false}>
      <div className="h-screen overflow-auto bg-slate-50">
        {/* Header */}
        <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white px-4 sm:px-6 py-3 sm:py-4 sticky top-0 z-10 shadow-md">
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                {emergencyContacts.map((contact, index) => (
                  <button
                    ...
                    className="flex items-center gap-4 bg-slate-50 hover:bg-slate-100 p-4 sm:p-5 rounded-xl border border-slate-200 hover:border-slate-300 active:scale-98 transition-all group w-full"
                  >
                    <div
                    ...
                    <Phone className="w-5 h-5 text-slate-400 group-hover:text-blue-700 transition-colors flex-shrink-0" />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 sm:p-6 mb-6">
              ...
              <Link
                ...
                className="flex items-center gap-4 bg-gradient-to-r from-blue-700 to-blue-900 text-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all group w-full"
              >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 sm:p-6">
              <h3 className="font-bold text-slate-900 text-lg sm:text-xl mb-4 flex items-center gap-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                  <span className="text-blue-700 font-bold text-lg flex-shrink-0">
                    3
                  </span>
                  <span className="text-sm sm:text-base text-slate-700">
