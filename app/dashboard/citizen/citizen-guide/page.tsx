      ...
      items: [
        {
          ...
          content:
            "Learn how to register as a citizen of Talon Dos and access all services.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                To register as a citizen of Talon Dos and access all online
      ...
      items: [
        {
          ...
          content:
            "Step-by-step guide to apply for a business permit in Talon Dos City.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Applying for a business permit in Talon Dos City is now easier
              ...
              <Link href="/dashboard/citizen/services/business-permit">
                <Button className="w-full bg-blue-700 hover:bg-blue-800 mt-4">
          ...
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                ...
                or structural modification in Talon Dos City.
              </p>
              <div className="space-y-3">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                    ...
                    <li>Proof of residency in Talon Dos City</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
      ...
      items: [
        ...
        },
        {
          ...
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Talon Dos City is prone to typhoons, floods, and earthquakes.
              ...
              <div className="space-y-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
                    Evacuation Centers in Talon Dos
                  </h4>
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                    <li>Talon Dos City Sports Complex</li>
                    <li>Talon Dos National High School</li>
