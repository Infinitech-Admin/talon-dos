...
export default function CitizenDashboard() {
  ...
  return (
    <CitizenLayout requireAuth={false}>
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">
          <span className="bg-gradient-to-r from-blue-600 to-blue-900 bg-clip-text text-transparent">
            Magandang umaga, Talon Dos Citizen!
          </span>
        </h1>
      ...
      {/* Help Section */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-900 rounded-2xl p-8 mb-8 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 bg-white text-blue-800 px-6 py-3 rounded-xl font-bold hover:shadow-xl transition-all"
          >
            View Reports
          </button>
          <button
            onClick={() => router.push("/dashboard/citizen/report-issue")}
            className="flex-1 bg-white/15 border border-white/40 text-white px-6 py-3 rounded-xl font-bold hover:bg-white/25 hover:shadow-xl transition-all"
          >
            Report an Issue
          </button>
        </div>
