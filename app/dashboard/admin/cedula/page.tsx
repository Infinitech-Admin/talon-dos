          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">
                Manage and review community tax certificate requests
              </p>
            </div>
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="sm:hidden divide-y divide-gray-200">
                    {cedulas.map((cedula) => (
                      <div key={cedula.id} className="p-4 space-y-3">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedCedula.birth_date)}
                        </p>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedCedula.created_at)}
                        </p>
                      </div>
                      {selectedCedula.approved_at && (
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-gray-900">
                            {formatDate(selectedCedula.approved_at)}
                          </p>
                        </div>
                      )}
                      {selectedCedula.expires_at && (
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-gray-900">
                            {formatDate(selectedCedula.expires_at)}
                          </p>
                        </div>
                      )}
                    </div>
