          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">
                Manage and review clearance requests
              </p>
            </div>
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="sm:hidden divide-y divide-gray-200">
                    {clearances.map((clearance) => (
                      <div key={clearance.id} className="p-4 space-y-3">
            ...
            <div className="bg-white sm:rounded-xl shadow-2xl w-full sm:max-w-4xl h-[95vh] sm:h-auto sm:max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 overscroll-contain">
                <div className="space-y-4 sm:space-y-6 pb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedClearance.birth_date)}
                        </p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedClearance.age} years old
                        </p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900 capitalize">
                          {selectedClearance.civil_status}
                        </p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedClearance.years_of_residency} years
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                      Contact Information
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2">
                      <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                      Purpose
                    </h3>
                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4 border border-gray-200">
                      <p className="text-sm sm:text-base text-gray-900 break-words">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      {selectedClearance.expires_at && (
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-gray-900">
                            {formatDate(selectedClearance.expires_at)}
                          </p>
                        </div>
                      )}
                    </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 w-full">
                  {selectedClearance.status === "pending" ? (
                    <>
                      ...
                      <button
                        onClick={() =>
                          handleUpdateStatus(selectedClearance.id, "rejected")
                        }
                      ...
                      <button
                        onClick={() =>
                          handleUpdateStatus(selectedClearance.id, "approved")
                        }
