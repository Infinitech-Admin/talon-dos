          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-900 text-white rounded-lg hover:from-blue-700 hover:to-blue-950 transition-all"
              >
              ...
              <button
                onClick={handleCreateNew}
                className="sm:hidden p-2 bg-gradient-to-r from-blue-600 to-blue-900 text-white rounded-lg hover:from-blue-700 hover:to-blue-950 transition-all"
              >
                <Plus className="w-5 h-5" />
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <button
              ...
              className="mt-4 w-full sm:w-auto px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
            >
              Search
            </button>
          </div>
                  ...
                  {modalMode === "view" ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-900 text-white rounded-lg hover:from-blue-700 hover:to-blue-950 transition-all text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
                            <svg
