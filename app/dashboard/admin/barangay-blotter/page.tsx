...
export default function AdminBarangayBlotterPage() {
  ...
  const [selectedBlotter, setSelectedBlotter] =
    useState<BarangayBlotter | null>(null);
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gradient-to-r from-blue-600 to-blue-900 text-white">
                          <tr>
                            ...
                            <th className="px-3 sm:px-4 py-3 text-center text-xs font-semibold uppercase whitespace-nowrap sticky right-0 bg-blue-900">
                              Actions
                            </th>
                          </tr>
                        </thead>
                          ...
                          {blotters.map((blotter) => (
                            ...
                            >
                              ...
                              <td className="px-3 sm:px-4 py-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                <div
                                  className="max-w-[150px] truncate"
                                  title={blotter.complaint_against}
                                >
                              ...
                              <td className="px-3 sm:px-4 py-3 text-sm text-gray-600 whitespace-nowrap">
                                <div
                                  className="max-w-[120px] truncate capitalize"
                                  title={blotter.incident_type}
                                >
                              ...
                              <td className="px-3 sm:px-4 py-3 text-center whitespace-nowrap sticky right-0 bg-white">
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-blue-100 text-blue-800 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors"
                                >
                    ...
                    {blotters.map((blotter) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                          ...
                          <span className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-100 text-blue-800 rounded-lg text-xs font-medium">
                            <Eye className="w-3 h-3" />
                            View
                          </span>
                        </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedBlotter.complaint_against}
                        </p>
                      </div>
                      <div className="sm:col-span-2">
                        <label className="text-xs sm:text-sm font-medium text-gray-500">
                        ...
                        {selectedBlotter.witness1_name && (
                          <>
                            ...
                            <div>
                              ...
                              <p className="text-sm sm:text-base text-gray-900">
                                {selectedBlotter.witness1_contact}
                              </p>
                            </div>
                          </>
                        )}
                        {selectedBlotter.witness2_name && (
                          <>
                            ...
                            <div>
                              ...
                              <p className="text-sm sm:text-base text-gray-900">
                                {selectedBlotter.witness2_contact}
                              </p>
                            </div>
                          </>
                        )}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedBlotter.created_at)}
                        </p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedBlotter.updated_at)}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 w-full">
                  {selectedBlotter.status === "pending" ? (
                    <>
                      ...
                      <button
                        onClick={() =>
                          handleUpdateStatus(selectedBlotter.id, "rejected")
                        }
                      ...
                      <button
                        onClick={() =>
                          handleUpdateStatus(selectedBlotter.id, "approved")
                        }
