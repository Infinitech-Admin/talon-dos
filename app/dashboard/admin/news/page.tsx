          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-all"
              >
              ...
              <button
                onClick={handleCreateNew}
                className="sm:hidden p-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-all"
              >
                <Plus className="w-5 h-5" />
              </button>
            </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
              <div className="border-b border-slate-200 px-4 sm:px-6 py-4 flex items-center justify-between flex-shrink-0">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700 resize-none"
                    ...
                    <div>
                      ...
                      {preview ? (
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:border-blue-700 hover:bg-blue-50 transition-colors">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700"
                            />
                          </div>
                          <p className="text-xs text-slate-500 mt-1">
                  ...
                  {modalMode === "view" ? (
                    <>
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-3 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors text-sm font-medium"
                      >
                        Edit
                      </button>
                    </>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-3 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-all text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
                            <svg
