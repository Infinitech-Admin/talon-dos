...
export default function AdminBuildingPermitPage() {
  ...
  const [selectedPermit, setSelectedPermit] = useState<BuildingPermit | null>(
    null,
  );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">
                Manage and review building permit requests
              </p>
            </div>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1 sm:flex-none sm:w-40">
                    ...
                    <select
                      ...
                      className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white"
                    >
              ...
              {loading ? (
                ...
                <>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gradient-to-r from-blue-600 to-blue-900 text-white">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-center text-xs font-semibold uppercase whitespace-nowrap">
                            Actions
                          </th>
                        </tr>
                      </thead>
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-center whitespace-nowrap">
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-100 text-blue-800 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors"
                              >
                  ...
                  <div className="sm:hidden divide-y divide-gray-200">
                    {permits.map((permit) => (
                      <div key={permit.id} className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                          ...
                          <button
                            onClick={() => handleViewPermit(permit)}
                            className="inline-flex items-center gap-1 px-3 py-2 bg-blue-100 text-blue-800 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors"
                          >
        ...
        {isModalOpen && selectedPermit && (
          <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
            <div className="bg-white sm:rounded-xl shadow-2xl w-full sm:max-w-4xl h-[95vh] sm:h-auto sm:max-h-[90vh] overflow-hidden flex flex-col">
              {/* Modal Header */}
              <div className="bg-gradient-to-r from-blue-600 to-blue-900 text-white px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div className="space-y-4 sm:space-y-6 pb-4">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2">
                      <Home className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                      Project Information
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <p className="text-sm sm:text-base text-gray-900 break-words">
                          {selectedPermit.project_description}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedPermit.lot_area
                            ? `${selectedPermit.lot_area} sq.m`
                            : "N/A"}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedPermit.floor_area
                            ? `${selectedPermit.floor_area} sq.m`
                            : "N/A"}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {selectedPermit.number_of_floors}
                        </p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500 flex items-center gap-1">
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatCurrency(selectedPermit.estimated_cost)}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2">
                      <User className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                      Owner Information
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2">
                      <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                      Property Location
                    </h3>
                      ...
                      <div className="border rounded-lg p-3 bg-gray-50">
                        ...
                        {selectedPermit.building_plans_url ? (
                          <a
                            ...
                            className="text-sm text-blue-800 hover:text-blue-900 underline flex items-center gap-1 mt-1"
                          >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedPermit.created_at)}
                        </p>
                      </div>
                      {selectedPermit.approved_at && (
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-gray-900">
                            {formatDate(selectedPermit.approved_at)}
                          </p>
                        </div>
                      )}
                      {selectedPermit.expires_at && (
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-gray-900">
                            {formatDate(selectedPermit.expires_at)}
                          </p>
                        </div>
                      )}
                    </div>
