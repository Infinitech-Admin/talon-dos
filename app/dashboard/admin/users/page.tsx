                  ...
                  {selectedUser.status === "pending" ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-3 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition-colors text-sm font-medium flex items-center justify-center gap-2"
                      >
              ...
              <div className="p-6">
                ...
                {(actionType === "rejected" ||
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent resize-none"
                    />
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-100 transition-colors text-sm font-medium"
                  >
                    Cancel
                  </button>
                  <button
