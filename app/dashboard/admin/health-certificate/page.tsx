...
export default function AdminHealthCertificatePage() {
  ...
  const [selectedCertificate, setSelectedCertificate] =
    useState<HealthCertificate | null>(null);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [isActionModalOpen, setIsActionModalOpen] = useState(false);
  const [actionType, setActionType] = useState<
    "approved" | "rejected" | "under_review" | "completed" | null
  >(null);
  ...
  const openActionModal = (
    type: "approved" | "rejected" | "under_review" | "completed",
  ) => {
    setActionType(type);
    setRemarks("");
  ...
  const handleUpdateStatus = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/health-certificate/${selectedCertificate.id}`,
        {
          method: "PUT",
          headers: {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">
                Manage and review health certificate requests
              </p>
            </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                  />
                </div>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1 sm:flex-none sm:w-40">
                    ...
                    <select
                      ...
                      className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent appearance-none bg-white"
                    >
              ...
              {loading ? (
                ...
                <>
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gradient-to-r from-blue-700 to-blue-900 text-white">
                          <tr>
                            ...
                            <th className="px-3 sm:px-4 py-3 text-center text-xs font-semibold uppercase whitespace-nowrap sticky right-0 bg-gradient-to-r from-blue-700 to-blue-900">
                              Actions
                            </th>
                          </tr>
                        </thead>
                            ...
                            >
                              <td className="px-3 sm:px-4 py-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                <div
                                  ...
                                  title={certificate.reference_number}
                                >
                              ...
                              <td className="px-3 sm:px-4 py-3 text-center whitespace-nowrap sticky right-0 bg-white">
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors"
                                >
                  ...
                  <div className="sm:hidden divide-y divide-gray-200">
                    {certificates.map((certificate) => (
                      <div key={certificate.id} className="p-4 space-y-3">
                        ...
                        <div className="space-y-1.5 text-xs text-gray-500">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span>
                              {certificate.age} years old /{" "}
                              {certificate.sex === "male" ? "Male" : "Female"}
                            </span>
                          </div>
                        </div>
        ...
        {isModalOpen && selectedCertificate && (
          <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
            <div className="bg-white sm:rounded-xl shadow-2xl w-full sm:max-w-4xl h-[95vh] sm:h-auto sm:max-h-[90vh] overflow-hidden flex flex-col">
              {/* Modal Header */}
              <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between sticky top-0 z-10">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            ...
                            {selectedCertificate.has_medications ? (
                              <p className="text-sm text-gray-900 mt-1">
                                {selectedCertificate.medications ||
                                  "Not specified"}
                              </p>
                            ) : (
                              <p className="text-sm text-gray-500 mt-1">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            ...
                            {selectedCertificate.has_conditions ? (
                              <p className="text-sm text-gray-900 mt-1">
                                {selectedCertificate.conditions ||
                                  "Not specified"}
                              </p>
                            ) : (
                              <p className="text-sm text-gray-500 mt-1">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900">
                          {formatDate(selectedCertificate.updated_at)}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="border-t border-gray-200 px-4 sm:px-6 py-3 bg-white shadow-lg flex-shrink-0">
                <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 w-full">
                  ...
                  selectedCertificate.status === "under_review" ? (
                    <>
                      <button
                        onClick={closeModal}
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-1">
                  {selectedCertificate.full_name} -{" "}
                  {selectedCertificate.reference_number}
                </p>
              </div>
              ...
              <div className="p-6">
                ...
                >
                  <p className="font-medium">
                    {actionType === "approved"
                      ? "This will approve the health certificate application."
                      : actionType === "rejected"
                        ? "This will reject the health certificate application."
                        : actionType === "completed"
                          ? "This will mark the certificate as completed and issued."
