...
export default function AdminBusinessPermitPage() {
  ...
  const [selectedPermit, setSelectedPermit] = useState<BusinessPermit | null>(
    null,
  );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">
                Manage and review business permit requests
              </p>
            </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-900 break-words">
                          {selectedPermit.business_category === "other" &&
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div className="sm:col-span-2">
                        ...
                        <p className="text-sm sm:text-base text-gray-900 break-words">
                          {selectedPermit.business_address}
                        </p>
                      </div>
