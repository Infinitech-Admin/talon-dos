...
export default function AdminMedicalAssistancePage() {
  ...
  const [selectedApplication, setSelectedApplication] =
    useState<MedicalAssistance | null>(null);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Manage and review medical assistance requests
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  <Heart className="w-12 h-12 text-slate-400 mb-3" />
                      ...
                      <table className="min-w-full divide-y divide-slate-200">
                        <thead className="bg-blue-700 text-white">
                          <tr>
                            ...
                            <th className="px-3 sm:px-4 py-3 text-center text-xs font-semibold uppercase whitespace-nowrap sticky right-0 bg-blue-700">
                              Actions
                            </th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-200 bg-white">
                          {applications.map((app) => (
                            ...
                            >
                              <td className="px-3 sm:px-4 py-3 text-sm font-medium text-blue-700 whitespace-nowrap">
                                {app.reference_number}
                              </td>
                              <td className="px-3 sm:px-4 py-3 text-sm text-slate-900 whitespace-nowrap">
                                <div
                              ...
                              <td className="px-3 sm:px-4 py-3 text-sm text-slate-600 whitespace-nowrap">
                                {formatCurrency(
                                  app.assistance_amount_requested,
                                )}
                              </td>
        ...
        {isModalOpen && selectedApplication && (
          <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
            <div className="bg-white sm:rounded-xl shadow-2xl w-full sm:max-w-4xl h-[95vh] sm:h-auto sm:max-h-[90vh] overflow-hidden flex flex-col">
              {/* Modal Header */}
              <div className="bg-blue-700 text-white px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between sticky top-0 z-10">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-slate-900 break-all">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-slate-900">
                          {formatDate(selectedApplication.birth_date)} (
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:gap-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                          ...
                          <p className="text-sm sm:text-base text-slate-900 break-words">
                            {selectedApplication.hospital_name}
                          </p>
                        </div>
                        <div>
                          <label className="text-xs sm:text-sm font-medium text-slate-500">
                          ...
                          <p className="text-sm sm:text-base text-slate-900">
                            {selectedApplication.doctor_name}
                          </p>
                        </div>
                        <div>
                          <label className="text-xs sm:text-sm font-medium text-slate-500 flex items-center gap-1">
                          ...
                          <p className="text-sm sm:text-base text-slate-900">
                            {formatCurrency(selectedApplication.estimated_cost)}
                          </p>
                        </div>
                      </div>
                    </div>
