                    ...
                    {messages.map((message) => (
                      <div key={message.id} className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-end pt-2 border-t border-gray-100">
                          <button
                            onClick={() => handleViewMessage(message)}
                            className="inline-flex items-center gap-1 px-3 py-2 bg-blue-100 text-blue-700 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors"
                          >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-sm sm:text-base text-blue-600 hover:text-blue-800 font-medium break-all"
                        >
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 sm:p-4">
                          <p className="text-sm sm:text-base text-gray-900 break-words whitespace-pre-wrap">
                          ...
                          {selectedMessage.replies.map((reply) => (
                            ...
                            >
                              <div className="flex items-start justify-between mb-3">
                                <div className="flex items-center gap-2">
                                  <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-blue-700 to-blue-900 text-white rounded-full text-sm font-semibold shadow-sm">
                                    <svg
                                      className="w-4 h-4"
                                      fill="currentColor"
                                      viewBox="0 0 20 20"
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm"
              ...
              <div className="border-t border-gray-200 px-4 sm:px-6 py-3 bg-white shadow-lg flex-shrink-0">
                <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 w-full">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-3 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSendingReply ? (
                      <>
                        <svg
