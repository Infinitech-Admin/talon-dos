...
const announcements = [
  {
    ...
    content:
      "City Hall will now open on weekends starting next month. This initiative aims to make government services more accessible to working citizens and families.",
    category: "Important",
    date: "Nov 13, 2024",
    featured: true,
  },
  ...
  },
  {
    ...
    excerpt: "Join us for the Annual Talon Dos City Festival this weekend!",
    content:
      "Join us for the Annual Talon Dos City Festival this weekend! Enjoy food, music, and community activities for the whole family.",
    category: "Event",
    date: "Nov 11, 2024",
    featured: false,
  },
      ...
      <section className="bg-gradient-to-br from-orange-600 to-emerald-600 text-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            from Talon Dos City Government.
          </motion.p>
        </div>
      </section>
