  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-lg shadow-lg p-4 md:p-6 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm md:text-base text-white/90 mb-4">
                ...
                help us understand how you use the site and enable performance
                analytics and personalized content. By accepting, you help us
                serve you better.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                ...
                <div className="flex gap-3 flex-1 sm:flex-initial sm:ml-auto">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-white text-blue-700 font-medium hover:bg-white/90 transition-colors text-sm"
                  >
                    Accept Cookies
                  </button>
                </div>
