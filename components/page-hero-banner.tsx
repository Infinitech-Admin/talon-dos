...
export default function PageHeroBanner({
  ...
  return (
    <div className="relative w-full h-72 md:h-96 overflow-hidden">
      ...
      {/* Gradient Overlay - solid blue, darker for better readability */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#1e3a8a]/90 to-[#1e40af]/90" />
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4 z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-1 bg-[#c2650a] rounded-full mx-auto mb-6"
          />
