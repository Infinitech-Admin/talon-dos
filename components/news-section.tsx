            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {news.map((article, index) => (
                <motion.div
                  ...
                  className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all cursor-pointer border border-gray-100 hover:border-[#1e40af]/30"
                >
                  {/* Image */}
                  <div className="relative h-56 overflow-hidden bg-slate-50 flex items-center justify-center">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase bg-[#1e40af] text-white shadow-lg">
                        {article.category}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <motion.div
                      whileHover={{ x: 5 }}
                      className="inline-flex items-center gap-2 text-sm font-bold text-[#1e40af]"
                    >
                      Read Full Story
                      <svg
                        className="w-4 h-4"
            ...
            >
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 p-6 md:p-8">
                {selectedArticle.image ? (
                  <div className="w-full flex items-center justify-center">
                    <img
                      ...
                      className="w-auto max-w-full h-auto max-h-[400px] rounded-xl shadow-lg object-contain"
                      onError={(e) => {
                        e.currentTarget.src = "/placeholder.svg";
                      }}
                    />
                  ...
                  <div className="w-full h-64 bg-[#1e40af] rounded-xl"></div>
                )}
                ...
                <div className="absolute top-4 left-4 z-20">
                  <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-sm font-bold uppercase bg-[#1e40af] text-white shadow-xl">
              ...
              <div className="flex-1 overflow-y-auto p-8 md:p-10">
                <div className="space-y-6">
                  {/* Title */}
                  <h2 className="text-3xl md:text-4xl font-bold text-[#1e40af] leading-tight">
                  ...
                  <div className="flex flex-wrap items-center gap-6 pb-6 border-b-2 border-gray-200">
                    <div className="flex items-center gap-2 text-gray-600">
                      <div className="w-10 h-10 bg-[#eaf0fb] rounded-full flex items-center justify-center">
              ...
              {/* Modal Footer */}
              <div className="border-t-2 border-gray-200 px-8 md:px-10 py-6 bg-slate-50">
                <motion.button
