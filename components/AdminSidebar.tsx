...
export default function AdminSidebar() {
  ...
  return (
    <aside className="hidden lg:block fixed top-0 left-0 h-full w-64 bg-blue-700 text-white shadow-2xl z-50 overflow-y-auto">
      <div className="p-6 flex flex-col min-h-full">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="font-bold text-base">Talon Dos City</h1>
