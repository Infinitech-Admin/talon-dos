...
export default function CitizenBottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40">
      ...
      <div
        className={`bg-gradient-to-br from-blue-50 to-white border-t border-gray-200 shadow-lg transition-all duration-300 overflow-hidden ${
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center gap-1 p-3 rounded-lg transition-all ${
                    active
                      ? "bg-gradient-to-br from-blue-600 to-blue-900 shadow-md"
      ...
      <nav className="bg-white border-t border-gray-200 shadow-lg">
        ...
        <div className="flex items-center justify-around">
          {mainNavigationItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <span
                  className={`text-xs font-medium ${active ? "text-blue-700 font-semibold" : "text-gray-600"}`}
                >
                  {item.label}
                </span>
              </button>
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 px-3 py-2 transition-colors flex-1 text-gray-600 hover:text-blue-700"
          >
            {showQuickAccess ? (
              <>
                <X size={22} className="text-blue-700" strokeWidth={2.5} />
